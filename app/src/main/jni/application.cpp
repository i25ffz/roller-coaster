...
static CRollerCoaster* gRollerCoaster;
...
static int engine_init_display(struct aengine* engine) {
    ...
    LOGW("Call engine_init_display get size:%dx%d", w, h);
    ...
    switch (cmd) {
        ...
        case APP_CMD_INIT_WINDOW:
            ...
            if (engine->app->window != NULL || engine->display == NULL) {
                ...
                gRollerCoaster = new CRollerCoaster(engine->width, engine->height);
                gRollerCoaster->AppInit();
